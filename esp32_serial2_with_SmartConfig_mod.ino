...
int16_t dataRaw[25];
int16_t resistSignal;
byte serialBuffer[66];
int DEVICE_TYPE = 0;
int resetPin = 4;
const size_t capacity = JSON_ARRAY_SIZE(25) + JSON_OBJECT_SIZE(7);
...
void setup()
{
  ...
  bool isSmartConfig = digitalRead(resetPin);
  ...
  // Put serial begin to final part
  // Serial 2 is 16(RX)&17(TX)
